...
read_mmmc ../constraints/${DESIGN}.mmmc.tcl
...
write_sdc -view AV1 > outputs/${DESIGN}_netlist_constraints_AV1.sdc
write_sdc -view AV2 > outputs/${DESIGN}_netlist_constraints_AV2.sdc 
write_sdc -view AV3 > outputs/${DESIGN}_netlist_constraints_AV3.sdc
write_sdc -view AV4 > outputs/${DESIGN}_netlist_constraints_AV4.sdc 
